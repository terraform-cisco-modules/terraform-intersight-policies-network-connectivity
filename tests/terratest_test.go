...
func TestFull(t *testing.T) {
	...
	instanceName := fmt.Sprintf("test-policies-dns-%s", uniqueId)
	...
	expectedJSONTemplate := `
{
	...
	"PreferredIpv4dnsServer": "208.67.220.220",
	"PreferredIpv6dnsServer": "2620:119:35::35"
}
`
	...
	iassert.AssertMOComply(t, fmt.Sprintf("/api/v1/networkconfig/Policies/%s", moid), expectedJSONTemplate, vars)
}
